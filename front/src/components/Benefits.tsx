...
import { ChatAlt2Icon, DocumentTextIcon, GlobeAltIcon, LockClosedIcon, PhotographIcon, } from '@heroicons/react/solid';
...
const benefits = [
  { title: "Use online", text: use_online, icon: <GlobeAltIcon className="h-6 w-6" /> },
  { title: "Image to text", text: img_to_txt, icon: <PhotographIcon className="h-6 w-6" /> },
  { title: "Convert PDF to DOC", text: pdf_to_doc, icon: <DocumentTextIcon className="h-6 w-6" /> },
  { title: "Works with iOS and Android", text: iOS_Android, icon: <ChatAlt2Icon className="h-6 w-6" /> },
  { title: "Secure conversion", text: secure_conversion, icon: <LockClosedIcon className="h-6 w-6" /> },
  { title: "Free tool", text: free_tool, icon: <PhotographIcon className="h-6 w-6" /> },
];
